...
void GLShaderFx::SetUniformVector4(int uniformid, glm::vec4& value)
{
	glUniform4f(uniformid, value.x, value.y, value.z, value.w);
}

void GLShaderFx::SetUniformInt(int uniformID, glm::int32 value)
{
	glUniform1i(uniformID, value);
}

void GLShaderFx::SetUniformFloat(int uniformID, float value)
{
