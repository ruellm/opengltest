...
//	glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE, 5 * sizeof(float), (void*)(3 * sizeof(float)));
	...
	shader.LoadFragmentShaderFromFile("./shaders/color_replace_fs.txt");
	shader.Build();
	...
	unsigned char *data = stbi_load("./textures/S1.png", &width, &height, &nrChannels, 0);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		shader.Use();
		int colorID = shader.GetUniformLocation("toColor");
		shader.SetUniformVector3(colorID, glm::vec3(1, 0, 0));
