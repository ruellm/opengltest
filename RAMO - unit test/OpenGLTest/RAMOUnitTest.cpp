...
int main()
{
	...
	camera.LookAt(
		glm::vec3(-65.91, 60.32, 84.86),
		glm::vec3(0, 1, 0),
		glm::vec3(0.55, 0.55, 0.55));
	
	//camera.LookAt(glm::vec3(0.251618952,8.00600243,20.3409557), glm::vec3(0.0203276295, -0.0655744523 ,-0.997640669), glm::vec3(0, 0, 0));
	//camera.LookAt(glm::vec3(-12.2866173, 23.1365128, -63.4827538), glm::vec3(0.195131257 ,-0.286280870, 0.938065588), glm::vec3(0, 0, 0));
	//camera.LookAt(glm::vec3(289.769989, 4.19024420,68.8968582), glm::vec3(0, 1, 0), glm::vec3(-0.909548223, -0.00355627364, -0.415583193));
	...
	FireBall fireball;
	fireball.Load();
	fireball.Attack(glm::vec3(0, 0, -500));
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		fireball.Draw(projectionMatrix, viewMatrix);
